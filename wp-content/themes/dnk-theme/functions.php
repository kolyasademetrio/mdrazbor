...
if (!function_exists('twentyfifteen_setup')) :
    ...
    function twentyfifteen_setup()
    {
        ...
        register_nav_menus(array(
            ...
            'secondary' => __('Второстепенное Меню', 'twentyfifteen'),
...
function custom_scripts()
{
    ...
    wp_register_style('custom-css', get_template_directory_uri() . '/css/custom-css/custom.css');
    ...
    wp_register_script('jquery', get_template_directory_uri() . '/js/custom-js/jquery-3.0.0.min.js', NULL, NULL, true);
    ...
    wp_register_script('formstyler-js', get_template_directory_uri() . '/plugins/formstyler/jquery.formstyler.js', array('jquery'), NULL, true);
    wp_enqueue_script('formstyler-js');

    wp_register_script('jquery-migrate-js', get_template_directory_uri() . '/js/custom-js/jquery-migrate-1.4.1.min.js', array('jquery'), NULL, true);
    ...
    wp_register_script('main-js', get_template_directory_uri() . '/js/custom-js/main.js', array('jquery'), NULL, true);
...
function custom_post_type()
{
    $labels = array(
        ...
        'add_new' => __('Добавить модель', 'twentyfifteen'),
        'edit_item' => __('Редактировать модель', 'twentyfifteen'),
        'update_item' => __('Обновить модель', 'twentyfifteen'),
        'search_items' => __('Найти модель', 'twentyfifteen'),
...
function nav_link_filter( $atts, $item, $args, $link_before ){
...
function custom_posts_per_page( $query ) {
    if ( $query->is_archive('models') && $query->is_main_query() && !is_admin() ) {
...
/* Extend WordPress search to include custom fields End */
